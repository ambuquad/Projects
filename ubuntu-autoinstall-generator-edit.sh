...
if [ ${all_in_one} -eq 1 ]; then
        ...
        mkdir "$tmpdir/nocloud/packets"
        mkdir "$tmpdir/nocloud/docker"
        cp "$user_data_file" "$tmpdir/nocloud/user-data"
        cp "docker/nginx_1_23_3.docker" "$tmpdir/nocloud/docker/"
        cp "packets/bridge-utils_1.6-2ubuntu1_amd64.deb" "$tmpdir/nocloud/packets/"
        cp "packets/containerd_1.5.9-0ubuntu1~20.04.6_amd64.deb" "$tmpdir/nocloud/packets/"
        cp "packets/dns-root-data_2019052802_all.deb" "$tmpdir/nocloud/packets/"
        cp "packets/dnsmasq-base_2.80-1.1ubuntu1.6_amd64.deb" "$tmpdir/nocloud/packets/"
        cp "packets/docker-compose_1.25.0-1_all.deb" "$tmpdir/nocloud/packets/"
        cp "packets/docker.io_20.10.12-0ubuntu2~20.04.1_amd64.deb" "$tmpdir/nocloud/packets/"
        cp "packets/libidn11_1.33-2.2ubuntu2_amd64.deb" "$tmpdir/nocloud/packets/"
        cp "packets/pigz_2.4-1_amd64.deb" "$tmpdir/nocloud/packets/"
        cp "packets/python3-cached-property_1.5.1-4_all.deb" "$tmpdir/nocloud/packets/"
        cp "packets/python3-docker_4.1.0-1_all.deb" "$tmpdir/nocloud/packets/"
        cp "packets/python3-dockerpty_0.4.1-2_all.deb" "$tmpdir/nocloud/packets/"
        cp "packets/python3-docopt_0.6.2-2.2ubuntu1_all.deb" "$tmpdir/nocloud/packets/"
        cp "packets/python3-texttable_1.6.2-2_all.deb" "$tmpdir/nocloud/packets/"
        cp "packets/python3-websocket_0.53.0-2ubuntu1_all.deb" "$tmpdir/nocloud/packets/"
        cp "packets/runc_1.1.0-0ubuntu1~20.04.2_amd64.deb" "$tmpdir/nocloud/packets/"
        cp "packets/ubuntu-fan_0.12.13ubuntu0.1_all.deb" "$tmpdir/nocloud/packets/"
